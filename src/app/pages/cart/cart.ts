...
@Component({
    selector: "app-cart",
    imports: [LucideAngularModule, RouterLink, ButtonComponent, CurrencyPipe],
    template:`
        <div class="py-8 mx-w-4xl mx-auto">
            ...
            @if (loading()) {
                ...
                <div class="flex flex-col items-center justify-center h-64 bg-white rounded-xl shadow-md">
                    ...
                    <p class="text-slate-400 mb-6">Looks like you have't added anything yet.</p>
